...
import { ArrayField, ArrayInput, CreateButton, DateInput, DeleteButton, Edit, ExportButton, FileField, FormTab, FunctionField, NumberInput, SaveButton, SelectInput, SimpleForm, SimpleFormIterator, TabbedForm, TextInput, Toolbar, TopToolbar, usePermissions, useRecordContext } from 'react-admin';
...
export const ArchivageEdit = () => {
    ...
    return(
    <Edit >
        <SimpleForm title=' ici '  toolbar={<MyToolbar  state={permissions} />}>
            {permissions ==="admin" && 
            <>
